...
<<<<<<< HEAD
// open kept running the build they first loaded. fdb1e1299d36 is replaced at
// build time with a hash of the page itself (scripts/stamp-sw.mjs), so this
// file now changes exactly when the app does.
const CACHE = "tiga-v15-fdb1e1299d36";
=======
// open kept running the build they first loaded. 1825815125da is replaced at
// build time with a hash of the page itself (scripts/stamp-sw.mjs), so this
// file now changes exactly when the app does.
const CACHE = "tiga-v15-1825815125da";
>>>>>>> c96184dc (Fix TIGA Model Lab invisible text: use app theme variables instead of hardcoded white)
