...
Start with the documentation index to discover
...
relevant answers. Explore function calling
...
query, and select useful context. Explore reranking
...
Fetched from https://github.com/typesafe-ai/skills/blob/main/skills/typesafe-ai/SKILL.md
on 2026-09-22. Re-fetch that file to update this copy.
