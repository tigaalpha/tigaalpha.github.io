...
const _L_RAW = {
  th: {
    ...
    gemsLabel: "Gems", gemExchange: "แลก 5💎→125🪙", gemHint: "ได้ Gems จากการเลื่อนขั้นตำนาน (Prestige) หรือซื้อเพิ่มได้", buyCurrencyBtn: "ซื้อ Coins/Gems เพิ่ม",
  ...
  zh: {
    ...
    gemsLabel: "Gems", gemExchange: "兑换 5💎→125🪙", gemHint: "可通过传奇晋级 (Prestige) 获得 Gems，也可直接购买", buyCurrencyBtn: "购买更多 Coins/Gems",
