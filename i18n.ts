...
export const L = {
  th: {
    ...
    camStop: "ปิดกล้อง", camNote: "กด ▶ ให้ครูดูมือ แล้วรับคำแนะนำทันที · กด ← หรือ ปิด เพื่อออกทุกเมื่อ",
  ...
  en: {
    ...
    camStop: "Stop Camera", camNote: "Tap ▶ and a teacher checks your hands, right away · tap ← or Close to leave anytime",
  ...
  zh: {
    ...
    camStop: "关闭摄像头", camNote: "点 ▶ 让老师看你的手，马上给建议 · 点 ← 或 关闭 随时退出",
