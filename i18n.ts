...
export const L = {
  th: {
    ...
    knowledgeQuestTitle: "ภารกิจความรู้", chatStartersHint: "สำรวจเพิ่มเติม",
    ...
    camRecapTitle: "สรุปคาบนี้", camRecapBetter: "ดีขึ้นจากครั้งก่อน! 📈", camRecapSame: "ทรงตัวเท่าครั้งก่อน", camRecapFirst: "คาบแรกที่บันทึกไว้ — ครั้งหน้าจะเทียบให้ดู", camRecapClose: "ปิด",
  ...
  en: {
    ...
    knowledgeQuestTitle: "KNOWLEDGE QUEST", chatStartersHint: "Explore more",
    ...
    camRecapTitle: "Session recap", camRecapBetter: "Better than last time! 📈", camRecapSame: "About the same as last time", camRecapFirst: "First recorded session — next time you'll see a comparison", camRecapClose: "Close",
  ...
  zh: {
    ...
    knowledgeQuestTitle: "知识任务", chatStartersHint: "探索更多",
    ...
    camRecapTitle: "本次小结", camRecapBetter: "比上次更好了！📈", camRecapSame: "和上次差不多", camRecapFirst: "第一次记录 — 下次会显示对比", camRecapClose: "关闭",
