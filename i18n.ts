...
export const L = {
  th: {
    ...
    playDemo: "▶ เล่นตัวอย่าง", pathTitle: "เส้นทางการเรียนรู้", heroTap: "กดคีย์ไหนก็ได้ — มีเสียงจริง ไม่ต้องสมัคร", heroPlayed: "เล่นไปแล้ว {n} โน้ต เลื่อนลงดูบทเรียนแรกกัน ↓", stepLabel: "ขั้นที่ {n}", pathSub: "เลือกหัวข้อ แล้ว AI จะสอนให้",
  ...
  en: {
    ...
    playDemo: "▶ PLAY DEMO", pathTitle: "PATHWAY OF LEARNING", heroTap: "Press any key — it really plays, no account needed", heroPlayed: "{n} notes already. Scroll down for your first lesson ↓", stepLabel: "STEP {n}", pathSub: "Pick a topic, AI will teach you",
  ...
  zh: {
    ...
    playDemo: "▶ 播放示例", pathTitle: "学习路径", heroTap: "按任意键 — 真的有声音，无需注册", heroPlayed: "已经弹了 {n} 个音 向下看看第一课 ↓", stepLabel: "第 {n} 步", pathSub: "选择主题，AI为您讲解",
