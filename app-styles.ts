...
.lbox{width:auto;min-width:38px;height:38px;padding:0 3px;white-space:nowrap;background:#d97757;border-radius:5px;display:flex;align-items:center;justify-content:center;font-family:'Orbitron',sans-serif;font-size:12px;color:#fff;font-weight:900}
