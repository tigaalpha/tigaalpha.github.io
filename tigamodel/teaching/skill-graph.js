...
export const SKILL_GRAPH_NODES = [
  ...
  { id: "sg:steady-beat", tier: 0, domain: "rhythm", th: "จังหวะนิ่ง (steady beat)", en: "Steady beat", zh: "稳定拍点" },
  { id: "sg:key-geography", tier: 0, domain: "technique", th: "รู้จักคีย์ 88 ตัว", en: "Keyboard geography", zh: "键盘布局（88键）" },
  { id: "sg:posture", tier: 0, domain: "technique", th: "ท่านั่งและรูปมือ", en: "Posture & hand shape", zh: "坐姿与手型" },
  { id: "sg:finger-numbers", tier: 0, domain: "sight-reading", th: "เลขนิ้ว 1-5", en: "Finger numbers", zh: "指法编号 1–5" },
  { id: "sg:black-key-groups", tier: 0, domain: "technique", th: "กลุ่มคีย์ดำ 2-3", en: "Black-key groups", zh: "黑键分组（2个/3个）" },
  /* Tier 1 — first notes & rhythm values */
  { id: "sg:white-key-names", tier: 1, domain: "sight-reading", th: "ชื่อคีย์ขาว C-B", en: "White-key names", zh: "白键音名 C–B" },
  { id: "sg:quarter-note", tier: 1, domain: "rhythm", th: "โน้ตตัวดำ (1 จังหวะ)", en: "Quarter note", zh: "四分音符" },
  { id: "sg:half-whole-notes", tier: 1, domain: "rhythm", th: "โน้ตครึ่ง-โน้ตเต็ม", en: "Half & whole notes", zh: "二分音符与全音符" },
  { id: "sg:5-note-position", tier: 1, domain: "technique", th: "ตำแหน่งมือ 5 นิ้ว", en: "5-finger position", zh: "五指手位" },
  { id: "sg:non-legato", tier: 1, domain: "technique", th: "เล่นแยกโน้ต (non-legato)", en: "Non-legato touch", zh: "非连奏触键" },
  { id: "sg:staff-basics", tier: 1, domain: "sight-reading", th: "บันไดพันธุศาสตร์ 5 เส้น", en: "Staff basics", zh: "五线谱基础" },
  { id: "sg:forte-piano", tier: 1, domain: "expression", th: "ดัง-เบา (f/p)", en: "Forte & piano", zh: "强与弱（f/p）" },
  /* Tier 2 — elementary reading & coordination */
  { id: "sg:eighth-notes", tier: 2, domain: "rhythm", th: "โน้ตครึ่งชั้น (2 ห้อง)", en: "Eighth notes", zh: "八分音符" },
  { id: "sg:c-major-5finger", tier: 2, domain: "technique", th: "สเกล 5 นิ้ว C major", en: "C-major 5-finger scale", zh: "C大调五指音阶" },
  { id: "sg:landmark-notes", tier: 2, domain: "sight-reading", th: "โน้ตหลัก (landmark)", en: "Landmark notes", zh: "基准音（地标音）" },
  { id: "sg:intervals-2nd-3rd", tier: 2, domain: "sight-reading", th: "คู่เสียง 2nd-3rd บนบันได", en: "2nd/3rd intervals on staff", zh: "五线谱上的二度与三度音程" },
  { id: "sg:legato", tier: 2, domain: "technique", th: "เล่นเชื่อม (legato)", en: "Legato", zh: "连奏" },
  { id: "sg:two-hand-together", tier: 2, domain: "coordination", th: "สองมือเหมือนกันพร้อมกัน", en: "Hands together (same)", zh: "双手齐奏" },
  { id: "sg:repeat-signs", tier: 2, domain: "sight-reading", th: "สัญลักษณ์ทำซ้ำ", en: "Repeat signs", zh: "反复记号" },
  { id: "sg:c-pentatonic-melody", tier: 2, domain: "repertoire", th: "ทำนองเพนทาโทนิก C", en: "C pentatonic melodies", zh: "C五声音阶旋律" },
  /* Tier 3 — real reading, real chords */
  { id: "sg:quarter-rest", tier: 3, domain: "rhythm", th: "พักตัวดำ", en: "Quarter rest", zh: "四分休止符" },
  { id: "sg:c-major-octave-scale", tier: 3, domain: "technique", th: "สเกล C major เต็มออกเทฟ", en: "C major one-octave scale", zh: "C大调一个八度音阶" },
  { id: "sg:staff-note-reading", tier: 3, domain: "sight-reading", th: "อ่านโน้ตทุกเส้น-ช่อง", en: "Full staff reading", zh: "五线谱全谱读谱" },
  { id: "sg:triads-c-f-g", tier: 3, domain: "harmony", th: "คอร์ด C F G", en: "C/F/G triads", zh: "C/F/G 三和弦" },
  { id: "sg:3-4-time", tier: 3, domain: "rhythm", th: "จังหวะ 3/4", en: "3/4 time", zh: "3/4 拍" },
  { id: "sg:hand-different-roles", tier: 3, domain: "coordination", th: "สองมือคนละบทบาท", en: "Hands, different roles", zh: "双手不同分工" },
  { id: "sg:dot-quarter", tier: 3, domain: "rhythm", th: "โน้ตดำจุดโท", en: "Dotted quarter", zh: "附点四分音符" },
  { id: "sg:crescendo-dim", tier: 3, domain: "expression", th: "เดินเสียง cresc/decresc", en: "Crescendo/ diminuendo", zh: "渐强与渐弱" },
  { id: "sg:staccato", tier: 3, domain: "technique", th: "สตัคคาโต", en: "Staccato", zh: "断奏" },
  { id: "sg:aa-form", tier: 3, domain: "repertoire", th: "โครงเพลง A-A", en: "A-A form pieces", zh: "A-A 曲式" },
  /* Tier 4 — elementary fluency */
  { id: "sg:chord-progressions-i-v", tier: 4, domain: "harmony", th: "เดินคอร์ด I-V", en: "I-V progressions", zh: "I–V 和弦进行" },
  { id: "sg:sharp-flat-accidentals", tier: 4, domain: "theory", th: "เครื่องหมาย sharp/flat", en: "Sharps & flats", zh: "升降记号（临时记号）" },
  { id: "sg:g-major-scale", tier: 4, domain: "technique", th: "สเกล G major", en: "G major scale", zh: "G大调音阶" },
  { id: "sg:eighth-rest", tier: 4, domain: "rhythm", th: "พักครึ่งชั้น", en: "Eighth rest", zh: "八分休止符" },
  { id: "sg:hand-independence-intro", tier: 4, domain: "coordination", th: "มืออิสระเบื้องต้น", en: "Hand independence (intro)", zh: "双手独立（入门）" },
  { id: "sg:ab-form", tier: 4, domain: "repertoire", th: "โครงเพลง A-B", en: "A-B form pieces", zh: "A-B 曲式" },
  { id: "sg:key-signatures-1", tier: 4, domain: "theory", th: "คีย์ซิกเนเจอร์ 1-2 เครื่องหมาย", en: "Key signatures (≤2)", zh: "调号（≤2个记号）" },
  { id: "sg:phrasing-2bar", tier: 4, domain: "expression", th: "ถอดวากย 2 ห้อง", en: "2-bar phrasing", zh: "两小节分句" },
  { id: "sg:thumb-under", tier: 4, domain: "technique", th: "นิ้วโป้งสอด (thumb-under)", en: "Thumb-under pass", zh: "拇指穿指" },
  { id: "sg:block-chords-lh", tier: 4, domain: "harmony", th: "คอร์ดบล็อกมือซ้าย", en: "Left-hand block chords", zh: "左手柱式和弦" },
  /* Tier 5 — early intermediate */
  { id: "sg:16th-notes", tier: 5, domain: "rhythm", th: "โน้ต 1/16", en: "Sixteenth notes", zh: "十六分音符" },
  { id: "sg:d-major-a-major", tier: 5, domain: "technique", th: "สเกล D และ A major", en: "D & A major scales", zh: "D大调与A大调音阶" },
  { id: "sg:triad-inversions", tier: 5, domain: "harmony", th: "คอร์ดกลับ (inversions)", en: "Triad inversions", zh: "三和弦转位" },
  { id: "sg:alberti-bass", tier: 5, domain: "accompaniment", th: "Alberti bass", en: "Alberti bass", zh: "阿尔贝蒂低音" },
  { id: "sg:triplets", tier: 5, domain: "rhythm", th: "ทริปเปิลเล็ต", en: "Triplets", zh: "三连音" },
  { id: "sg:ii-v-i-basic", tier: 5, domain: "harmony", th: "ii-V-I เบื้องต้น", en: "ii-V-I basics", zh: "ii-V-I 基础" },
  { id: "sg:damper-pedal", tier: 5, domain: "pedal", th: "แป้น sustain เบื้องต้น", en: "Damper pedal basics", zh: "延音踏板入门" },
  { id: "sg:syncopation", tier: 5, domain: "rhythm", th: "ซิงโคเปชัน", en: "Syncopation", zh: "切分节奏" },
  { id: "sg:aba-form", tier: 5, domain: "repertoire", th: "โครงเพลง A-B-A", en: "A-B-A form", zh: "A-B-A 曲式" },
  { id: "sg:canon-form", tier: 5, domain: "repertoire", th: "คานอน / เลียนแบบ", en: "Canon/imitation pieces", zh: "卡农/模仿曲式" },
  { id: "sg:minors-natural", tier: 5, domain: "theory", th: "ไมเนอร์ธรรมชาติ", en: "Natural minor keys", zh: "自然小调" },
  /* Tier 6 — intermediate craft */
  { id: "sg:dom7-chords", tier: 6, domain: "harmony", th: "คอร์ด dominant 7", en: "Dominant 7th chords", zh: "属七和弦" },
  { id: "sg:all-major-scales", tier: 6, domain: "technique", th: "สเกลเมเจอร์ครบ 12 คีย์", en: "All 12 major scales", zh: "全部12个大调音阶" },
  { id: "sg:arpeggios-2oct", tier: 6, domain: "technique", th: "อาร์เปจโจ้ 2 ออกเทฟ", en: "2-octave arpeggios", zh: "两个八度的琶音" },
  { id: "sg:dotted-8th-16th", tier: 6, domain: "rhythm", th: "จังหวะ dotted-8th + 16th", en: "Dotted-8th/16th rhythms", zh: "附点八分与十六分节奏" },
  { id: "sg:min7-maj7", tier: 6, domain: "harmony", th: "คอร์ด min7/maj7", en: "min7/maj7 chords", zh: "小七/大七和弦" },
  { id: "sg:voicing-melody-above", tier: 6, domain: "expression", th: "เด่นเมโลดี้เหนือคอร์ด", en: "Melody-above-accompaniment voicing", zh: "旋律高于伴奏的织体" },
  { id: "sg:sonatina-form", tier: 6, domain: "repertoire", th: "โซนาทิน่า", en: "Sonatinas", zh: "小奏鸣曲" },
  { id: "sg:sight-read-level1", tier: 6, domain: "sight-reading", th: "อ่านตามสายตาระดับ 1", en: "Sight-reading level 1", zh: "视奏（一级）" },
  { id: "sg:3-against-2", tier: 6, domain: "rhythm", th: "3 ต่อ 2 (polyrhythm)", en: "3-against-2 polyrhythm", zh: "三对二复合节奏" },
  { id: "sg:sustain-pedal-refined", tier: 6, domain: "pedal", th: "เหยียบแป้นเชื่อมรอบ", en: "Legato pedal changes", zh: "切分踏板（连音换踏）" },
  { id: "sg:baroque-dance-styles", tier: 6, domain: "repertoire", th: "บทเต้นยุคบาโรก", en: "Baroque dance movements", zh: "巴洛克舞曲风格" },
  /* Tier 7 — advanced-intermediate gateway */
  { id: "sg:sonata-exposition", tier: 7, domain: "repertoire", th: "โซนาตา (exposition)", en: "Sonata exposition", zh: "奏鸣曲式（呈示部）" },
  { id: "sg:cadence-types", tier: 7, domain: "harmony", th: "แคเดนซ์ครบชนิด", en: "All cadence types", zh: "各类终止式" },
  { id: "sg:inventions-2voice", tier: 7, domain: "repertoire", th: "2-voice invention", en: "2-voice inventions", zh: "二声部创意曲" },
  { id: "sg:rubato", tier: 7, domain: "expression", th: "Rubato อย่างมีเหตุผล", en: "Purposeful rubato", zh: "有目的的弹性速度（Rubato）" },
  { id: "sg:mini-modulations", tier: 7, domain: "harmony", th: "ย้ายคีย์ใกล้ชิด", en: "Closely-keyed modulation", zh: "近关系转调" },
  { id: "sg:chromatic-passing", tier: 7, domain: "technique", th: "โน้ตเครโมติกผ่านทาง", en: "Chromatic passing technique", zh: "半音经过句技巧" },
  { id: "sg:jazz-voicings-shell", tier: 7, domain: "harmony", th: "Jazz shell voicing", en: "Jazz shell voicings", zh: "爵士 Shell Voicing 和弦配置" },
  { id: "sg:perf-ready-2min", tier: 7, domain: "performance", th: "เล่นต่อหน้าได้ 2 นาที", en: "Performance-ready 2-minute piece", zh: "可登台的2分钟曲目" },
  { id: "sg:sight-read-level2", tier: 7, domain: "sight-reading", th: "อ่านตามสายตาระดับ 2", en: "Sight-reading level 2", zh: "视奏（二级）" },
  { id: "sg:memorize-secure", tier: 7, domain: "performance", th: "จำเพลงได้มั่นคง", en: "Secure memorization", zh: "牢固的背谱能力" },
  { id: "sg:seventh-chords-lh", tier: 7, domain: "harmony", th: "คอร์ด 7 มือซ้ายเต็ม", en: "Full left-hand 7th chords", zh: "左手完整七和弦" },
  { id: "sg:romantic-tone", tier: 7, domain: "expression", th: "เสียงโรแมนติก (arm weight)", en: "Romantic tone (arm weight)", zh: "浪漫派音色（手臂重量）" },
  { id: "sg:ornament-exec", tier: 7, domain: "technique", th: "ออร์นาเมนต์เบื้องต้น (trill/mordent)", en: "Ornament execution (trill/mordent)", zh: "装饰音演奏（颤音/波音）" },
  { id: "sg:octaves-secure", tier: 7, domain: "technique", th: "อ็อกเทฟที่มั่นคง ไม่บาดเจ็บ", en: "Secure, injury-safe octaves", zh: "稳固不受伤的八度演奏" },
  { id: "sg:arpeg-lh-patterns", tier: 7, domain: "accompaniment", th: "อาร์เปจโจ้มือซ้ายเป็นประกอบ", en: "Left-hand arpeggio accompaniment", zh: "左手琶音伴奏音型" },
  { id: "sg:duet-collab", tier: 7, domain: "performance", th: "เล่นรวมกับผู้อื่น (ensemble)", en: "Playing with others (ensemble)", zh: "与他人合奏" },
  { id: "sg:scale-thirds-sixths", tier: 7, domain: "technique", th: "สเกลในคู่ 3rd/6th เบื้องต้น", en: "Scales in 3rds/6ths (intro)", zh: "三度/六度双音音阶（入门）" },
  { id: "sg:dynamics-layering", tier: 7, domain: "expression", th: "ชั้นเสียง 3 ชั้น (เมโลดี้/ฮาร์มอนี/เบส)", en: "3-layer dynamics (melody/harmony/bass)", zh: "三层力度层次（旋律/和声/低音）" },
];
