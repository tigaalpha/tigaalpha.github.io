...
export const ROADMAP_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { n: 46, th: "Mastery criteria ต่อทักษะ", en: "Mastery criteria", stars: 3, status: "todo" },
  ...
  },
  {
    ...
    items: [
      ...
      { n: 62, th: "Skill graph 80 โหนด + prerequisite edges", en: "Skill graph", stars: 3, status: "todo" },
  ...
  },
  {
    ...
    items: [
      ...
      { n: 73, th: "Hint ladder 4 ชั้น", en: "Hint ladder", stars: 3, status: "todo" },
      { n: 74, th: "Session state machine warmup→recap", en: "Session machine", stars: 2, status: "todo" },
      { n: 75, th: "Adaptive difficulty จาก skill graph", en: "Adaptive difficulty", stars: 3, status: "todo" },
      ...
      { n: 78, th: "Recap generator 3 ข้อ + การบ้าน", en: "Recap generator", stars: 3, status: "todo" },
  ...
  },
  {
    ...
    items: [
      { n: 81, th: "Eval cases 30→120 เคส", en: "120 eval cases", stars: 3, status: "todo" },
      { n: 82, th: "Golden answers โดยครูจริง 20 ข้อ", en: "Golden answers", stars: 3, status: "todo" },
      { n: 83, th: "Auto-grader ทฤษฎีอัตโนมัติ", en: "Theory auto-grader", stars: 3, status: "todo" },
      { n: 84, th: "A/B สองโมเดลดู diff ข้างกัน", en: "Model A/B diff", stars: 2, status: "todo" },
      { n: 85, th: "Regression alarm ก่อนเปิดใช้", en: "Regression alarm", stars: 3, status: "todo" },
      { n: 86, th: "Rubric คุณภาพการสอน 6 มิติ", en: "6-dim rubric", stars: 3, status: "todo" },
