...
export default function IndirectCompetitorsPage() {
  ...
  return analysis === undefined ? <Skeleton className="h-96" /> : <CompetitorCategoryView analysis={analysis} kind="indirect" />;
}
