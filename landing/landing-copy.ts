...
export const C = {
  th: {
    ...
    openWhy: "คุณกำลังเปิดในแอป (Facebook/LINE/TikTok) — ล็อกอิน Google จะไม่ทำงาน แตะปุ่มมุมขวาบนเพื่อเปิดในเบราว์เซอร์",
  ...
  en: {
    ...
    openWhy: "You are inside an app’s built-in browser (Facebook/LINE/TikTok) — Google sign-in will not work here. Tap the button top right to open in your real browser.",
  ...
  zh: {
    ...
    openReal: "在真正的浏览器中打开",
    openTop: "用浏览器打开",
    openWhy: "您正在应用内置浏览器中（Facebook/LINE/TikTok）— Google 登录无法使用。请点击右上角按钮，用真正的浏览器打开。",
