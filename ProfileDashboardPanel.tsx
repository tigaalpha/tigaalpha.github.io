  ...
  return (
        <div className="profscroll">
          ...
          <ProfilePage lang={lang} session={session} profile={profile} onSignOut={onSignOut} coins={coins} gems={gems}
            ...
            charModel={charModel} setCharModel={setCharModel} modelLocked={modelLocked} modelCores={modelCores} charHat={charHat} charOutfit={charOutfit} charWeapon={charWeapon} charAccessory={charAccessory} owned={owned} />
        </div>
  );
}
