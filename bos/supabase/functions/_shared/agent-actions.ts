...
export type AgentActionType = "create_task" | "send_notification" | "send_line" | "create_schedule";
...
export const AUTO_EXECUTE_ACTION_TYPES: readonly AgentActionType[] = ["create_task", "send_notification"];
...
export const AGENT_ACTION_TYPES: readonly AgentActionType[] = ["create_task", "send_notification", "send_line", "create_schedule"];
