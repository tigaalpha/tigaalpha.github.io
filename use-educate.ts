...
export const EDU_COPY = {
  th: {
    firstCoins: { ic: "🪙", title: "Coins แรกของคุณ!", body: "Coins สะสมได้จากการซ้อมเปียโนทุกรอบ และอย่าลืมเปิดหีบสมบัติฟรีทุกวันที่หน้าโปรไฟล์ — ของข้างในสุ่มได้ทั้ง Coins และไอเทม", cta: "🎁 ไปที่โปรไฟล์", go: "profile" },
    ...
    pet: { ic: "🐾", title: "ใกล้ได้สัตว์เลี้ยงแล้ว!", body: "สัตว์เลี้ยงไม่ใช่ของตกแต่ง — แต่ละตัวให้พลังต่างกันจริง เช่น ดาเมจ +10% ฟื้นเลือดทุกยก หรือเกจสกิลเร็ว +15% ใช้ได้ในสนามประลอง เก็บ Coins อีกหน่อยก้อรับตัวแรกได้", cta: "🐾 ดูสัตว์เลี้ยง", go: "pet" },
    ...
    rich: { ic: "🪙", title: "Coins เยอะแบบนี้ ใช้ให้คุ้มเลย", body: "คุณมี Coins พอซื้อของในร้านได้หลายชิ้นแล้ว — สัตว์เลี้ยงตัวใหม่หรือสกินหุ่นระดับหายาก รออยู่ อย่าเก็บไว้เฉย ๆ น่าเสียดาย", cta: "🛍️ ไปเลือกของ", go: "shop" },
  },
  en: {
  ...
  zh: {
    firstCoins: { ic: "🪙", title: "你的第一枚 Coins！", body: "每次练琴都能赚 Coins，别忘了每天在个人主页免费开一次宝箱——里面随机有 Coins 和道具。", cta: "🎁 去个人主页", go: "profile" },
    chest: { ic: "🎁", title: "你的宝箱在等你", body: "每天免费开一次——练得越多，奖品越好。趁今天还没结束赶紧开。", cta: "🎁 立即开箱", go: "chest" },
    pet: { ic: "🐾", title: "宠物近在咫尺！", body: "宠物不是装饰——每只都有真实战斗加成：伤害+10%、每波回血、技能槽+15%，在PvP竞技场里真正生效。再攒一点 Coins，第一只就是你的。", cta: "🐾 查看宠物", go: "pet" },
    shop: { ic: "🛍️", title: "商店有两个世界", body: "战斗装备真的能打（机体皮肤、宠物、武器）；工作室装备负责好看（钢琴皮肤、相框、主题）。逛逛吧——心仪的东西比想象中便宜。", cta: "🛍️ 打开商店", go: "shop" },
    rich: { ic: "🪙", title: "Coins 这么多，花在刀刃上", body: "你已经买得起好几件商店商品了——新宠物或稀有机体皮肤都在等你，别让它们闲置。", cta: "🛍️ 去挑一件", go: "shop" },
  },
};
